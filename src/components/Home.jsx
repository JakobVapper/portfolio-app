...
const Home = () => {
    return (
        <div className='bg-black pt-[80px] lg:px-[100px]' id='Home'>
            <div className='overflow-hidden min-h-screen lg:flex lg:flex-row lg:justify-between md:flex md:flex-col'>
