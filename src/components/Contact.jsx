...
const Contact = () => {
    ...
    return (
        <div className='flex flex-row pt-[200px]'>
            <div className='w-full bg-black flex place-content-start px-[100px] items-center p-4'>
                <div className='flex flex-col max-w-[600px] w-full'>
                    <motion.div initial="initial" animate={isVisible ? "animate" : "initial"} variants={textVariants} className='pb-8'>
                        ...
                        <motion.p className='text-white py-4 text-center'>Send me an email!</motion.p>
                    </motion.div>
            ...
            <div className='flex place-items-center'>
                <Lottie className='w-[600px]' animationData={Animation}></Lottie>
            </div>
        </div>
    )
}
